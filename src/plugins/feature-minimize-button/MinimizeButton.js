(function ($, pluginsNamespace, util, EaselApi) {
  "use strict";
   ...
   */
  EaselApi.prototype.minimizeCanvas = function() {
   ...
   */
  EaselApi.prototype.restoreCanvas = function() {
    this.drawer.api.checkIsActive();
    var tool = this.drawer.getPluginInstance('MinimizeButton');
    tool.restoreCanvas();
  };
...
})(jQuery, Easel.plugins, Easel.util, Easel.EaselApi);